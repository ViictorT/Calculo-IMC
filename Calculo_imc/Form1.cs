    ...
    public partial class Form1 : Form
    {
        ...
        private void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            { /*Declaração de variáveis variável recebe conteúdo do textbox*/
                ...
                /*Condições de acordo com os resultados dos cálculos Serão exibidas mensagens, configuração das messagebox, (mensagens, botões, ícones) como são várias condições temos um encadeamento de ifs*/ 
                if (imc < 18.49)
        ...
        {
            //não está fucionando este objeto, para limpar
            txtAltura.Text = "";
            txtPeso.Text = "";
            txtImc.Text = "";
        }
